...
export const LAYER_STORAGE_PREFIX = 'jp-option-pro:chart-layers:v1';
...
export const LAYERS: LayerDef[] = [
  ...
  { id: 'topix_rs', group: 'pane', kind: 'rs', label: t('TOPIX 相对强度') },
];
...
export const PRESETS: Record<Exclude<PresetId, 'custom'>, PresetDef> = {
  ...
  momentum: {
    label: t('动量'),
    enabled: ['ma20', 'ma50', 'ma200', 'rsi', 'macd', 'topix_rs'],
    maxPatterns: 0,
    maxLabels: 4,
    minShapeQuality: 0.45,
    onlyActive: true,
