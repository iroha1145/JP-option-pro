"""Japan-site algorithm IDs, versions, and resolution rules.

Screener ranking and radar sort are independent. The system default remains
the original Japan production algorithms. A0 / T1 are optional views; their
version strings are jp-* so they never imply US input identity.
"""
...
T1_VERSION = "jp-t1-daily-priority-v1"
T1_SCORE_BASIS = "production_order + t1_daily_conditions_boost"

SCREENER_PRODUCTION_VERSION = "jp-strength-v1"
RADAR_PRODUCTION_VERSION = "jp-radar-v1"
SCREENER_PRODUCTION_BASIS = "final_ranking_score"
RADAR_PRODUCTION_BASIS = "alert_priority_desc,event_id_asc"
...
SCREENER_ALIASES = {
    ...
    "jp-strength-v1": PRODUCTION_ALGORITHM,
    "a0": A0_ALGORITHM,
...
RADAR_ALIASES = {
    ...
    "original": PRODUCTION_ALGORITHM,
    "legacy": PRODUCTION_ALGORITHM,
    "jp-radar-v1": PRODUCTION_ALGORITHM,
    "t1": T1_ALGORITHM,
