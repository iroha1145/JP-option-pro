"""Deterministic daily patterns, ported from option-pro technical/auto_patterns.py.
...
from app.services.radar.price_action import find_swings as _find_swings

ALGORITHM_VERSION = "jp-auto-patterns-v2"
_LOOKBACK = 252
_MIN_BARS = 40
_MIN_SPAN = 20
_TOUCH_ATR = 0.35
